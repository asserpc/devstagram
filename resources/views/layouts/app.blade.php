        ...
        <header class="p-5 border-b bg-white shadow">
            <div class="container mx-auto flex justify-between items-center">
                ...
                <nav class="flex gap-6 items-center">
                    ...
                    @auth
                        <a class="font-blod uppercase text-gray-600 text-sm" href="{{route('posts.index',auth()->user()->username)}}">
                        ...
                        <form action="{{ route('logout') }}" method="post">
                            @csrf
                            <button  class="font-blod uppercase text-gray-600 text-sm" type="submit">Cerrar</button>             
                        </form>
